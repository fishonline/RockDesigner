...
namespace Rock.Orm.Data.Oracle
{
    /// <summary>
    ...
    public class OracleDbProvider : DbProvider
    {
        ...
        public override void AdjustParameter(DbParameter param)
        {
            ...
            oracleParam.OracleType = OracleType.NClob;
            oracleParam.Value = Rock.Orm.Common.SerializationManager.Serialize(value);
        }
        ...
        {
            get { return new Rock.Orm.Common.Oracle.OracleQueryFactory(); }
        }
