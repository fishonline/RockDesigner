...
namespace Rock.Orm.Data.MsAccess
{
	/// <summary>
    ...
    public class AccessDbProvider : DbProvider
    {
        ...
        public override void AdjustParameter(DbParameter param)
        {
            ...
            oleDbParam.OleDbType = OleDbType.LongVarWChar;
            oleDbParam.Value = Rock.Orm.Common.SerializationManager.Serialize(value);
        }
        ...
        {
            get { return new Rock.Orm.Common.MsAccess.MsAccessQueryFactory(); }
        }
        #endregion
    }
}