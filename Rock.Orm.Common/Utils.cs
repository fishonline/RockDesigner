...
namespace Rock.Orm.Common
{
    ...
    public abstract class Util
    {
        ...
        {
            return CN.Rock.Common.CommonUtils.DefaultValue(type);
        }
        ...
        /// <returns>BatchSize infos of all the types and there base classes/interfaces</returns>
        public static PropertyInfo[] DeepGetProperties(params Type[] types)
        {
            return CN.Rock.Reflection.ReflectionUtils.DeepGetProperties(types);
        }
        ...
        {
            return CN.Rock.Common.CommonUtils.GetType(fullName);
        }
        ...
        {
            return CN.Rock.Reflection.ReflectionUtils.DeepGetProperty(type, propertyName);
        }
        ...
        {
            return CN.Rock.Reflection.ReflectionUtils.DeepGetField(type, name, isPublic);
        }
        ...
        public static string FormatParamVal(object val)
        {
            ...
            else if (val is Rock.Orm.Common.ExpressionClip)
            {
                return Util.ToString((Rock.Orm.Common.ExpressionClip)val) ;
            }
            else if (type.IsEnum)
            {
        ...
        public static string ToString(Rock.Orm.Common.IExpression expr)
        {
            if (expr == null)
            {
                return null;
