...
namespace CN.Rock.DesignByContract
{
    /// <summary>
    ...
    public sealed class Check
    {
        ...
        Conditional("DBC_CHECK_INVARIANT"),
        Conditional("DBC_CHECK_POSTCONDITION")]
        public static void Ensure(bool assertion, string message, ApplicationException inner)
        {
            if (UseExceptions)
            {
        ...
        [Conditional("DBC_CHECK_ALL"),
        Conditional("DBC_CHECK_INVARIANT")]
        public static void Invariant(bool assertion, string message, ApplicationException inner)
        {
            if (UseExceptions)
            {
        ...
        /// </summary>
        [Conditional("DBC_CHECK_ALL")]
        public static void Assert(bool assertion, string message, ApplicationException inner)
        {
            if (UseExceptions)
            {
    ...
    /// <summary>
    /// ApplicationException raised when a contract is broken.
    ...
    /// <summary>
    /// ApplicationException raised when a precondition fails.
    /// </summary>
    public class PreconditionException : DesignByContractException
    {
        /// <summary>
        /// Precondition ApplicationException.
        /// </summary>
    ...
    /// <summary>
    /// ApplicationException raised when a postcondition fails.
    /// </summary>
    public class PostconditionException : DesignByContractException
    {
        ...
        /// Postcondition ApplicationException.
        /// </summary>
        public PostconditionException(string message, ApplicationException inner) : base(message, inner) { }
    }

    /// <summary>
    /// ApplicationException raised when an invariant fails.
    /// </summary>
    public class InvariantException : DesignByContractException
    {
        /// <summary>
        /// Invariant ApplicationException.
        /// </summary>
        ...
        /// Invariant ApplicationException.
        /// </summary>
        public InvariantException(string message, ApplicationException inner) : base(message, inner) { }
    }

    /// <summary>
    /// ApplicationException raised when an assertion fails.
    /// </summary>
    public class AssertionException : DesignByContractException
    {
        /// <summary>
        /// Assertion ApplicationException.
        /// </summary>
        ...
        /// Assertion ApplicationException.
        /// </summary>
        public AssertionException(string message, ApplicationException inner) : base(message, inner) { }
    }

    #endregion // ApplicationException classes
