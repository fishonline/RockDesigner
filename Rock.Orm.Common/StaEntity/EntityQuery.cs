...
namespace Rock.Orm.Common
{
    ...
    /// </summary>
    [Serializable]
    public class PropertyItem : Rock.Orm.Common.ExpressionClip
    {
        ...
        public PropertyItem(string propertyName, string typeFullName) : 
            this(propertyName, MetaDataManager.GetEntityConfiguration(typeFullName))
        {
        }
    ...
    //    public PropertyItemParam(Rock.Orm.Common.ExpressionClip expr) : base()
    //    {
    //        this.expr = Rock.Orm.Common.ExpressionClip.CreateCloneExpression(expr);
    //    }
    ...
    //    {
    //        Rock.Orm.Common.ExpressionClip expr = Rock.Orm.Common.ExpressionClip.CreateCloneExpression(left.expr)
    //            .AppendExpressions(Rock.Orm.Common.QueryOperator.Add, right.expr);
    ...
    //        Rock.Orm.Common.ExpressionClip expr = Rock.Orm.Common.ExpressionClip.CreateParameterExpression(right.DbType, left)
    //            .AppendExpressions(Rock.Orm.Common.QueryOperator.Add, right.expr);
    //        PropertyItemParam pip = new PropertyItemParam(expr);
    //        pip.propertyConfig = right.propertyConfig;
    //        return pip;
    ...
    //        Rock.Orm.Common.ExpressionClip expr = Rock.Orm.Common.ExpressionClip.CreateCloneExpression(left.expr)
    //            .AppendExpressions(Rock.Orm.Common.QueryOperator.Add, 
    //            Rock.Orm.Common.ExpressionClip.CreateParameterExpression(left.DbType, right));
    //        PropertyItemParam pip = new PropertyItemParam(expr);
    ...
    //    {
    //        Rock.Orm.Common.ExpressionClip expr = Rock.Orm.Common.ExpressionClip.CreateCloneExpression(left.expr)
    //            .AppendExpressions(Rock.Orm.Common.QueryOperator.Subtract, right.expr);
    //        PropertyItemParam pip = new PropertyItemParam(expr);
    //        pip.propertyConfig = right.propertyConfig;
    //        return pip;
    //    }
    ...
    //        Rock.Orm.Common.ExpressionClip expr = Rock.Orm.Common.ExpressionClip.CreateCloneExpression(left.expr)
    //            .AppendExpressions(Rock.Orm.Common.QueryOperator.Subtract, 
    //            Rock.Orm.Common.ExpressionClip.CreateParameterExpression(left.DbType, right));
    //        PropertyItemParam pip = new PropertyItemParam(expr);
    //        pip.propertyConfig = left.propertyConfig;
    //        return pip;
    ...
    //    {
    //        Rock.Orm.Common.ExpressionClip expr = Rock.Orm.Common.ExpressionClip.CreateCloneExpression(left.expr)
    //            .AppendExpressions(Rock.Orm.Common.QueryOperator.Multiply, right.expr);
    //        PropertyItemParam pip = new PropertyItemParam(expr);
    //        pip.propertyConfig = right.propertyConfig;
    //        return pip;
    //    }
    ...
    //        Rock.Orm.Common.ExpressionClip expr = Rock.Orm.Common.ExpressionClip.CreateCloneExpression(left.expr)
    //            .AppendExpressions(Rock.Orm.Common.QueryOperator.Multiply, 
    //            Rock.Orm.Common.ExpressionClip.CreateParameterExpression(left.DbType, right));
    //        PropertyItemParam pip = new PropertyItemParam(expr);
    //        pip.propertyConfig = left.propertyConfig;
    //        return pip;
    ...
    //    {
    //        Rock.Orm.Common.ExpressionClip expr = Rock.Orm.Common.ExpressionClip.CreateCloneExpression(left.expr)
    //            .AppendExpressions(Rock.Orm.Common.QueryOperator.Divide, right.expr);
    //        PropertyItemParam pip = new PropertyItemParam(expr);
    //        pip.propertyConfig = right.propertyConfig;
    //        return pip;
    //    }
    ...
    //        Rock.Orm.Common.ExpressionClip expr = Rock.Orm.Common.ExpressionClip.CreateCloneExpression(left.expr)
    //            .AppendExpressions(Rock.Orm.Common.QueryOperator.Divide, 
    //            Rock.Orm.Common.ExpressionClip.CreateParameterExpression(left.DbType, right));
    //        PropertyItemParam pip = new PropertyItemParam(expr);
    //        pip.propertyConfig = left.propertyConfig;
    //        return pip;
    ...
    //    {
    //        Rock.Orm.Common.ExpressionClip expr = Rock.Orm.Common.ExpressionClip.CreateCloneExpression(left.expr)
    //            .AppendExpressions(Rock.Orm.Common.QueryOperator.Modulo, right.expr);
    //        PropertyItemParam pip = new PropertyItemParam(expr);
    //        pip.propertyConfig = right.propertyConfig;
    //        return pip;
    //    }
    ...
    //        Rock.Orm.Common.ExpressionClip expr = Rock.Orm.Common.ExpressionClip.CreateCloneExpression(left.expr)
    //            .AppendExpressions(Rock.Orm.Common.QueryOperator.Modulo, 
    //            Rock.Orm.Common.ExpressionClip.CreateParameterExpression(left.DbType, right));
    //        PropertyItemParam pip = new PropertyItemParam(expr);
    //        pip.propertyConfig = left.propertyConfig;
    //        return pip;
    ...
    //        {
    //            newWhere.whereClip.And(left.expr, Rock.Orm.Common.QueryOperator.IsNULL, null);
    //        }
    //        else if (((object)left) == null)
    //        {
    //            newWhere.whereClip.And(right.expr, Rock.Orm.Common.QueryOperator.IsNULL, null);
    //        }
    //        else
    //        {
    //            newWhere.whereClip.And(left.expr, Rock.Orm.Common.QueryOperator.Equal, right.expr);
    //        }
    ...
    //        else
    //        {
    //            newWhere.whereClip.And(left.expr, Rock.Orm.Common.QueryOperator.Equal, 
    //                Rock.Orm.Common.ExpressionClip.CreateParameterExpression(left.DbType, right));
    //        }
    ...
    //        else
    //        {
    //            newWhere.whereClip.And(Rock.Orm.Common.ExpressionClip.CreateParameterExpression(right.DbType, left), 
    //                Rock.Orm.Common.QueryOperator.Equal, right.expr);
    //        }
    ...
    //        else
    //        {
    //            newWhere.whereClip.And(left.expr, Rock.Orm.Common.QueryOperator.Greater, right.expr);
    //        }
    ...
    //        else
    //        {
    //            newWhere.whereClip.And(left.expr, Rock.Orm.Common.QueryOperator.Less, right.expr);
    //        }
    ...
    //        newWhere.whereClip.And(left.expr, Rock.Orm.Common.QueryOperator.Greater, 
    //            Rock.Orm.Common.ExpressionClip.CreateParameterExpression(left.DbType, right));
    ...
    //        newWhere.whereClip.And(left.expr, Rock.Orm.Common.QueryOperator.Less, 
    //            Rock.Orm.Common.ExpressionClip.CreateParameterExpression(left.DbType, right));
    ...
    //        newWhere.whereClip.And(Rock.Orm.Common.ExpressionClip.CreateParameterExpression(right.DbType, left), 
    //            Rock.Orm.Common.QueryOperator.Greater, right.expr);
    ...
    //        newWhere.whereClip.And(Rock.Orm.Common.ExpressionClip.CreateParameterExpression(right.DbType, left), 
    //            Rock.Orm.Common.QueryOperator.Less, right.expr);
    ...
    //        else
    //        {
    //            newWhere.whereClip.And(left.expr, Rock.Orm.Common.QueryOperator.GreaterOrEqual, right.expr);
    //        }
    ...
    //        else
    //        {
    //            newWhere.whereClip.And(left.expr, Rock.Orm.Common.QueryOperator.LessOrEqual, right.expr);
    //        }
    ...
    //        newWhere.whereClip.And(left.expr, Rock.Orm.Common.QueryOperator.GreaterOrEqual, 
    //            Rock.Orm.Common.ExpressionClip.CreateParameterExpression(left.DbType, right));
    ...
    //        newWhere.whereClip.And(left.expr, Rock.Orm.Common.QueryOperator.LessOrEqual, 
    //            Rock.Orm.Common.ExpressionClip.CreateParameterExpression(left.DbType, right));
    ...
    //        newWhere.whereClip.And(Rock.Orm.Common.ExpressionClip.CreateParameterExpression(right.DbType, left), 
    //            Rock.Orm.Common.QueryOperator.GreaterOrEqual, right.expr);
    ...
    //        newWhere.whereClip.And(Rock.Orm.Common.ExpressionClip.CreateParameterExpression(right.DbType, left), 
    //            Rock.Orm.Common.QueryOperator.LessOrEqual, right.expr);
    ...
    //    {
    //        Rock.Orm.Common.ExpressionClip expr = Rock.Orm.Common.ExpressionClip.CreateEmptyExpression()
    //            .AppendExpressions(Rock.Orm.Common.QueryOperator.BitwiseNOT, 
    //            left.expr);
    //        PropertyItemParam pip = new PropertyItemParam(expr);
    //        pip.propertyConfig = left.propertyConfig;
    //        return pip;
        ...
        where EntityType : Entity, new()
    {
        ...
        private static string ParseWhereClip(Rock.Orm.Common.WhereClip where)
        {
            if (Rock.Orm.Common.WhereClip.IsNullOrEmpty(where))
            {
                return null;
            }
            ...
            if (!string.IsNullOrEmpty(sql))
            {
                ...
                while (en.MoveNext())
                {
                    ...
                    else if (en.Current.Value.Value is Rock.Orm.Common.ExpressionClip)
                    {
                        sql = sql.Replace('@' + en.Current.Key, Util.ToString((Rock.Orm.Common.ExpressionClip)en.Current.Value.Value));
                    }
                    else
                    {
                        sql = sql.Replace('@' + en.Current.Key, Util.FormatParamVal(en.Current.Value.Value));
        ...
        private static Rock.Orm.Common.WhereClip BuildEqualWhereClip(object[] values, List<PropertyConfiguration> pks)
        {
            Rock.Orm.Common.WhereClip where = null;
        ...
        private object FindScalar(string column, Rock.Orm.Common.WhereClip where)
        {
            if (column.Contains("("))
            {
                //aggregate query
        ...
        public EntityType Find(params object[] pkValues)
        {
            ...
            Rock.Orm.Common.WhereClip where = BuildEqualWhereClip(pkValues, pks);
        ...
        /// <returns></returns>
        public EntityType Find(Rock.Orm.Common.WhereClip where)
        {
        ...
        /// <param name="where">The where.</param>
        /// <returns></returns>
        public bool Exists(Rock.Orm.Common.WhereClip where)
        {
            //Check.Require(where != null, "where could not be null.");
        ...
        /// <param name="where">The where.</param>
        /// <returns></returns>
        public EntityType[] FindArray(Rock.Orm.Common.WhereClip where)
        {
        ...
        /// <returns></returns>
        public EntityType[] FindArray(Rock.Orm.Common.WhereClip where, OrderByClip orderBy)
        {
            return ToEntityArray(dt.Select(ParseWhereClip(where), orderBy == null ? null :  RemoveTableAliasNamePrefixes(orderBy.ToString())));
        }

        public EntityType[] FindArray(Rock.Orm.Common.WhereClip where, OrderByClip orderBy, int topCount, int skipCount)
        {
            return ToEntityArray(dt.Select(ParseWhereClip(where), orderBy == null ? null :  RemoveTableAliasNamePrefixes(orderBy.ToString())), topCount, skipCount);
        }
        ...
        {
            return ToEntityArray(dt.Select(null, orderBy == null ? null :  RemoveTableAliasNamePrefixes(orderBy.ToString())));
        }
        ...
        /// <returns></returns>
        public object[] FindSinglePropertyArray(PropertyItem property, WhereClip where, OrderByClip orderBy, int topCount, int skipCount)
        {
            Check.Require(((object)property) != null, "property could not be null.");
            ...
            List<object> list = new List<object>();
            DataRow[] rows = dt.Select(ParseWhereClip(where), orderBy == null ? null : RemoveTableAliasNamePrefixes(orderBy.ToString()));
            if (rows != null && rows.Length > 0)
            {
        ...
        /// <param name="orderBy">The order by.</param>
        /// <returns></returns>
        public object[] FindSinglePropertyArray(PropertyItem property, WhereClip where, OrderByClip orderBy)
        {
            return FindSinglePropertyArray(property, where, orderBy, int.MaxValue, 0);
        }
        ...
        /// <param name="where">The where.</param>
        /// <returns></returns>
        public object Avg(PropertyItem property, Rock.Orm.Common.WhereClip where)
        {
        ...
        /// <param name="where">The where.</param>
        /// <returns></returns>
        public object Sum(PropertyItem property, Rock.Orm.Common.WhereClip where)
        {
        ...
        /// <param name="where">The where.</param>
        /// <returns></returns>
        public object Max(PropertyItem property, Rock.Orm.Common.WhereClip where)
        {
        ...
        /// <param name="where">The where.</param>
        /// <returns></returns>
        public object Min(PropertyItem property, Rock.Orm.Common.WhereClip where)
        {
        ...
        /// <returns></returns>
        public object Count(PropertyItem property, Rock.Orm.Common.WhereClip where, bool isDistinct)
        {
