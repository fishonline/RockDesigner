...
namespace Rock.Orm.Common
{
    ...
    public delegate void DynEntityArrayItemChangeHandler(string propertyName, object item);

    /// <summary>
    /// Interface for entity array lists
    /// </summary>
    public interface IDynEntityArrayList
    {
        /// <summary>
        /// Gets or sets the on add callback handler.
        /// </summary>
        /// <value>The on add callback handler.</value>
        DynEntityArrayItemChangeHandler OnAddCallbackHandler { get; set; }
        /// <summary>
        /// Gets or sets the on remove callback handler.
        /// </summary>
        /// <value>The on remove callback handler.</value>
        DynEntityArrayItemChangeHandler OnRemoveCallbackHandler { get; set; }
        /// <summary>
    ...
    /// <summary>
    /// The dynamic entity array type.
    /// </summary>
    /// <typeparam name="EntityType">entity type</typeparam>
    public class DynEntityArrayList : MarshalByRefObject, IDynEntityArrayList
    {
        private List<DynEntity> list = new List<DynEntity>();
        private DynEntityArrayItemChangeHandler onAddCallbackHandler;
        private DynEntityArrayItemChangeHandler onRemoveCallbackHandler;
        ...
        public void AddRange(DynEntity[] items)
        {
            if (items != null)
            {
                foreach (DynEntity item in items)
                {
                    Add(item);
                }
            }
        ...
        public void Clear()
        {
            ...
            {
                foreach (DynEntity item in list)
                {
        ...
        /// <value>The on add callback handler.</value>
        [XmlIgnore]
        public DynEntityArrayItemChangeHandler OnAddCallbackHandler
        {
            get
            {
        ...
        /// <value>The on remove callback handler.</value>
        [XmlIgnore]
        public DynEntityArrayItemChangeHandler OnRemoveCallbackHandler
        {
            get
            {
